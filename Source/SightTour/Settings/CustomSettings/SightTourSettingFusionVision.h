...
#include "SightTourSettingFusionVision.generated.h"

/**
 * USightTourSettingFusionVision
 */
UCLASS()
class SIGHTTOUR_API USightTourSettingFusionVision : public UGameSettingValue
{
	GENERATED_BODY()
