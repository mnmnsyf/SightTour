...
#include "SightTourSettingKeyboardInput.generated.h"

/**
 * USightTourSettingKeyboardInput
 */
UCLASS()
class SIGHTTOUR_API USightTourSettingKeyboardInput : public UGameSettingValue
{
	GENERATED_BODY()
