...
#include "SightTourSettingsListEntrySetting_KeyboardInput.generated.h"
...
class USightTourSettingsListEntrySetting_KeyboardInput : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	TObjectPtr<USightTourSettingKeyboardInput> KeyboardInputSetting;
